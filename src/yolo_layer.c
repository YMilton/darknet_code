    ...
    for (b = 0; b < l.batch; ++b) {
        for (n = 0; n < l.n; ++n) {
            ...
            if (l.new_coords) {
                ...
                activate_array(l.output + bbox_index, 2 * l.w*l.h, LOGISTIC);        // x,yµÄsigmoid
                int obj_index = entry_index(l, b, n*l.w*l.h, 4);
                activate_array(l.output + obj_index, (1 + l.classes)*l.w*l.h, LOGISTIC);  // conf,class_confµÄsigmoid
            }
